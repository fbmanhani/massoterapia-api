...
-- -----------------------------------------------------
-- Table `massoterapiadb`.`tb_massoterapeuta`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `massoterapiadb`.`tb_massoterapeuta` (
  `id_massoterapeuta` BINARY(16) NOT NULL,
  `co_massoterapeuta` VARCHAR(50) NOT NULL,
  `no_massoterapeuta` VARCHAR(150) NOT NULL,
  `st_ativo` TINYINT NOT NULL DEFAULT 1,
  PRIMARY KEY (`id_massoterapeuta`),
  UNIQUE INDEX `co_massoterapeuta_UNIQUE` (`co_massoterapeuta` ASC) VISIBLE)
ENGINE = MyISAM
...
CREATE TABLE IF NOT EXISTS `massoterapiadb`.`tb_sessao` (
  ...
  INDEX `fk_tb_sessao_tb_massoterapeuta_idx` (`id_massoterapeuta` ASC) VISIBLE,
